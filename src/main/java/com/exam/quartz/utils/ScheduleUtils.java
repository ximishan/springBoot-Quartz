...
package com.exam.quartz.utils;

import com.exam.quartz.entity.ScheduleJob;
import com.exam.quartz.exception.RRException;
import org.quartz.*;
...
public class ScheduleUtils {
    ...
    public static void createScheduleJob(Scheduler scheduler, ScheduleJob scheduleJob) {
        try {
        	//构建job信息
            JobDetail jobDetail = JobBuilder.newJob(com.exam.quartz.utils.ScheduleJob.class).withIdentity(getJobKey(scheduleJob.getJobId())).build();
